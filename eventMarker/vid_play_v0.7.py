...
import sys, os, re
from PyQt6.QtCore import Qt, QUrl, QTime, QTimer, QEvent, QRectF
from PyQt6.QtGui import QAction, QKeyEvent, QPainter, QColor
...
class VideoPlayer(QMainWindow):
    ...
    def open_file(self):
        ...
        file_name, _ = QFileDialog.getOpenFileName(self, "Select video file", "", "Video (*.mp4 *.avi *.mkv *.mov)")
        if file_name:
    ...
    def saveEventToFile(self):
        ...
        try:
            ...
            with open(f'Marked Events/{fnm}.txt', 'w', encoding='utf-8') as f:
